...
export class PlayAreaComponent implements AfterViewInit, OnInit, OnChanges {
    ...
    private configureBaseSocketFeatures() {
        this.socketService.on('drawBoard', (placementData: PlacementData) => {
            console.log("Column  " + placementData.column);
            console.log("Row   " + placementData.row);
            console.log("Direction " + placementData.direction );
            console.log("word:  "+ placementData.word);
